        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8">
                <ul class="flex space-x-8">
                    <li
                        class="p-2 text-[--serondary-color] hover:bg-emerald-400 border-r-2 border-gray-900 hover:border-white rounded-sm transition-all">
                        <a href="#">Home</a>
                    </li>
                    ...
                    <li class="relative group">
                        <a
                            class="p-2 text-[--serondary-color] hover:bg-emerald-400 border-r-2 border-gray-900 hover:border-white rounded-sm transition-all flex items-center">
                            About
                    ...
                    <li
                        class="p-2 text-[--serondary-color]e hover:bg-emerald-400 border-r-2 border-gray-900 hover:border-white rounded-sm transition-all">
                        <a href="#">Gallery</a>
                    </li>
                    <li
                        class="p-2 text-[--serondary-color] hover:bg-emerald-400 border-r-2 border-gray-900 hover:border-white rounded-sm transition-all">
